...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/03 16:21:48 by hsetyamu          #+#    #+#             */
/*   Updated: 2022/09/03 16:21:51 by hsetyamu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin(int size, char **strs, char *sep)
{
	...
	str = malloc(sizeof(char) * get_length(size, strs, sep));
	if (!str)
		return (NULL);
	*str = 0;
	i = 0;
...
int main(void)
{
	char *strs[] = {"1", "two", "3", "four", "5", "six", "7", "eight"};
	char *sep = "...";
	char *res;
	int size = 6;
